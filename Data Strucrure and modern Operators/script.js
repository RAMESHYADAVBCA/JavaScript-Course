...
// MAPS: Fundamentals
const rest = new Map();
rest.set("name", "Classico Itraliano");
rest.set(1, "Firenze", "Italy");
console.log(rest.set(2, "Lisbon, prortugal"));
...
console.log(new Set("RameshYadav").size);
...
/*
////////////////////////////////////
//  LOOPING OBJECTS: OBJECT KEYS. VALUES AND ENTERS
